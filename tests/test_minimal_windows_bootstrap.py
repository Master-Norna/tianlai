...
class MinimalWindowsBootstrapTests(unittest.TestCase):
    ...
    def test_bootstrap_is_bom_safe_minimal_and_idempotent(self) -> None:
        ...
        self.assertIn("Get-NormalizedMachine", text)
        self.assertIn('"amd64", "x64", "x86_64"', text)
        self.assertIn('$facts.System -ne "Windows"', text)
        self.assertIn('$facts.NormalizedMachine -ne "x86_64"', text)
