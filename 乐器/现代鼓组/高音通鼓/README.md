...
高音通鼓为膜鸣打击,键 60-65 分别选择边击/槌击/滚奏变体,不做十二平均律校准(详见 [`音准校准.json`](音准校准.json))

## 试听

固定事件:`examples/高音通鼓_奏法.events.json`;
渲染 7.00 s,峰值 0.420046,
RMS 0.013221,削波 0;
WAV SHA-256 `67a3635af944…`。复算脚本 [`核验试听.py`](核验试听.py)。
