...
def main() -> None:
    ...
    report = generate_dedicated_audition_verification(
        here / "乐器.json",
        ROOT / "examples" / "管弦钹_奏法.events.json",
        ROOT / "output" / "管弦钹_奏法_candidate.wav",
        output_path=here / "试听核验.json",
        coverage=[
            "all 10 public articulations",
            "weak/strong",
            "RR hits",
            "releasable rolls",
            "short/medium/long prerecorded crescendos",
        ],
    )
